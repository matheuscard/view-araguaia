...
import { KanbanCard, Comment, ListName, Task } from 'src/app/araguaia/api/kanban';
import { Member } from 'src/app/araguaia/api/member';
import { KanbanAppComponent } from '../kanban.app.component';
import { MemberService } from 'src/app/araguaia/service/member.service';
