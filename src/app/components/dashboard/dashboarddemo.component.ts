...
@Component({
    ...
    styleUrls: ['../dashboard/tabledemo.scss']
})
export class DashboardDemoComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.growth = '620,076Kg';
        this.avgCustomer = '620Kg';

        this.timelineEvents = [
            {transaction: 'POLARIS RGR MODELO RANGER 57.. #28492', amount: '+R$ 11.618,60', date: 'Junho 13, 2020 11:09 AM',
                icon: PrimeIcons.CHECK, iconColor: '#0F8BFD', amountColor: '#00D0DE'},
            {transaction: 'ENERGIA PRINCESA #94830', amount: '-R$570.00', date: 'Junho 13, 2020 08:22 AM',
                icon: PrimeIcons.REFRESH, iconColor: '#FC6161', amountColor: '#FC6161'},
            {transaction: '200 SEMEM A 20,00 CD / 200 SEMEM A 30,00 CD #5849', amount: '+R$50.00', date: 'Junho 12, 2020 02:56 PM',
                icon: PrimeIcons.PLUS, iconColor: '#0BD18A', amountColor: '#0BD18A'},
            {transaction: '1 TOPLINE #3382', amount: '+R$3830.00', date: 'Junho 11, 2020 06:11 AM',
                icon: PrimeIcons.CHECK, iconColor: '#0F8BFD', amountColor: '#00D0DE'},
            {transaction: 'ENTRADA DE #4738', amount: '+R$845.00', date: 'Junho 11, 2020 03:50 AM',
                icon: PrimeIcons.CHECK, iconColor: '#0F8BFD', amountColor: '#00D0DE'},
            {transaction: 'FALHA DE PAGAMENTO DE #60958', amount: 'R$1450.00', date: 'Junho 10, 2020 07:54 PM',
                icon: PrimeIcons.EXCLAMATION_TRIANGLE, iconColor: '#EC4DBC', amountColor: '#EC4DBC'},
            {transaction: 'ENTRADA DE #5748', amount: '+R$50.00', date: 'Junho 09, 2020 11:37 PM',
                icon: PrimeIcons.CHECK, iconColor: '#0F8BFD', amountColor: '#00D0DE'},
            {transaction: 'ENERGIA PRINCESA #5849', amount: '-R$240.00', date: 'Junho 09, 2020 08:40 PM',
                icon: PrimeIcons.MINUS, iconColor: '#FC6161', amountColor: '#FC6161'},
        ];

        this.countryChart = {
            labels: ['X', 'Outro', 'Y', 'Z', 'W', 'Y', 'H'],
            datasets: [
                {
        ...
        this.customerChart = {
            labels: ['Janeiro', 'Março', 'Maio', 'Agosto', 'Outubro', 'Dezembro'],
            datasets: [
                {
